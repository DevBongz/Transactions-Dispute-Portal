...
public sealed class GeminiOptions
{
    ...
    // Feature 1 — natural-language extraction. Flash for low latency.
    public string ExtractionModel { get; set; } = "gemini-2.5-flash";
    ...
    public string ClassificationModel { get; set; } = "gemini-2.5-flash";
    ...
    public string SummaryModel { get; set; } = "gemini-2.5-flash";
    public int SummaryMaxTokens { get; set; } = 512;
    public int SummaryTimeoutSeconds { get; set; } = 20;
